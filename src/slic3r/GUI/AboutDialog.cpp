...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("nacod3d Slicer is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("nacod3d Slicer is a derivative of OrcaSlicer, which is based on PrusaSlicer and BambuStudio"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    text_list.push_back(_L("nacod3d Slicer continues that chain. It is a derivative of OrcaSlicer — the slicing engine, the printer profiles and nearly everything you see here are their work, and the credit for it is theirs. What nacod3d adds is a layer of assistance that helps you understand how to print better."));
