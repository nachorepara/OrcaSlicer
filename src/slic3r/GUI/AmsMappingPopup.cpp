...
void AmsReplaceMaterialDialog::create()
{
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(194, 65, 12), StateColor::Pressed), std::pair<wxColour, int>(wxColour(234, 88, 12), StateColor::Normal)); // Orca: accent teal button (not brand green)
