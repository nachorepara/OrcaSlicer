    ...
    : paddingSize(10, 8)
{
    background_color = StateColor(
        ...
        std::make_pair(0xfb923c, (int) StateColor::Hovered | StateColor::Checked),
        std::make_pair(0xEA580C, (int) StateColor::Checked),
...
wxString btn_regular[10]  = {"#DFDFDF", "#DFDFDF", "#D4D4D4", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#262E30", "#EA580C", "#EA580C"};
wxString btn_confirm[10]  = {"#DFDFDF", "#EA580C", "#F97316", "#EA580C", "#EA580C", "#6B6A6A", "#FEFEFE", "#FEFEFE", "#fb923c", "#FDBA74"};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#E14747", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#FFFFFD", "#EA580C", "#EA580C"};
