    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(194, 65, 12), StateColor::Pressed);
    border_color.append(wxColour(249, 115, 22), StateColor::Hovered);
    border_color.append(0xEA580C, StateColor::Normal);
    ...
    background_color.append(wxColour(194, 65, 12), StateColor::Pressed);
    background_color.append(wxColour(249, 115, 22), StateColor::Hovered);
    background_color.append(0xEA580C, StateColor::Normal);
